...
<html>
    ...
    <script>
        var step1Image = "{{ asset('/img/precipcard/step-1.png') }}";
        var step1ActiveImage = "{{ asset('/img/precipcard/step-1-active.png') }}";
        var step2Image = "{{ asset('/img/precipcard/step-2.png') }}";
        var step2ActiveImage = "{{ asset('/img/precipcard/step-2-active.png') }}";
        var step3Image = "{{ asset('/img/precipcard/step-3.png') }}";
        var step3ActiveImage = "{{ asset('/img/precipcard/step-3-active.png') }}";
        var step4Image = "{{ asset('/img/precipcard/step-4.png') }}";
        var step4ActiveImage = "{{ asset('/img/precipcard/step-4-active.png') }}";
    </script>
